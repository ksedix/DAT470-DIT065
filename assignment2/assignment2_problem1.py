...
def simulate(n: int,
    ...
    with multiprocessing.Pool(processes=num_workers) as pool:
        results = np.array(pool.map(play_blackjack, [basic_strategy]*n))
    ...
    time_sequential = end_sequential - start_sequential - time_parallel
    time_total = end_sequential - start_sequential
    #time_parallel_frac = time_parallel * 100 / time_total
    #time_sequential_frac = time_sequential * 100 / time_total
    #print(f'The sequential part of simulate took: {time_sequential} seconds and accounted for {time_sequential_frac}% of the total running time')
    #print(f'The parallel part of simulate took: {time_parallel} seconds and accounted for {time_parallel_frac}% of the total running time')
    #print(f'The total running time of simulate took: {time_total} seconds')

    print(f'The sequential part of simulate took: {time_sequential}')
    print(f'The parallel part of simulate took: {time_parallel} seconds')
    print(f'The total running time of simulate took: {time_total} seconds')
...
if __name__ == '__main__':
    ...
    res = simulate(n, num_workers=args.workers, seed=args.seed)
